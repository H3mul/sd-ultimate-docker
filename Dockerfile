...
FROM python:3.11@sha256:d9a071b927b838408fccebb9cc02adb3d5059369de0e257db2ef5ecb24f893e3
...
ENV INVOKEAI_VERSION=v5.6.2
# renovate: datasource=pypi depName=InvokeAI
ENV INVOKEAI_PYPI_VERSION=5.6.2
