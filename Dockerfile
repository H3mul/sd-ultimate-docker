FROM python:3.14@sha256:8676e2e7a07b736aeea297a13a42ab7b235940623a7fcd3815c336662ffe33c8
...
ENV INVOKEAI_VERSION=v6.7.0
# renovate: datasource=pypi depName=InvokeAI
ENV INVOKEAI_PYPI_VERSION=6.7.0
