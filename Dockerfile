FROM python:3.14@sha256:b0a637ba74875a5f9ce0a7844cd8e2b76e97650072d0f455410182a1b7d6d62f
...
ENV INVOKEAI_VERSION=v6.11.1
# renovate: datasource=pypi depName=InvokeAI
ENV INVOKEAI_PYPI_VERSION=6.11.1
