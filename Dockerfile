...
FROM python:3.11@sha256:125314956d382ce03edbb9ce11910a7c204694de07db19c9fd5f389d41727720
...
ENV INVOKEAI_VERSION=v5.8.1
# renovate: datasource=pypi depName=InvokeAI
ENV INVOKEAI_PYPI_VERSION=5.8.1
