FROM python:3.14@sha256:93c7740550a7b5442cf895d66c834ddcad32e0e71f6775a8d43b4d36b307ad7e
...
ENV INVOKEAI_VERSION=v6.10.0
# renovate: datasource=pypi depName=InvokeAI
ENV INVOKEAI_PYPI_VERSION=6.10.0
