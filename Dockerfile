...
FROM python:3.11@sha256:706d1233c61a31507c4f8939cfd6a924610b51174c095f33e2c537fb904a1e76
...
ENV INVOKEAI_VERSION=v5.4.0
# renovate: datasource=pypi depName=InvokeAI
ENV INVOKEAI_PYPI_VERSION=5.4.1
