...
FROM python:3.11@sha256:a3e280261e448b95d49423532ccd6e5329c39d171c10df1457891ff7c5e2301b
...
ENV INVOKEAI_VERSION=v5.10.1
# renovate: datasource=pypi depName=InvokeAI
ENV INVOKEAI_PYPI_VERSION=5.10.1
